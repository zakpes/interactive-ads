function generateScratchOne(){

  'use strict';

  var canvas = document.getElementById('scratch-1'),
...
function generateScratchTwo(){

    'use strict';
  
    var canvas = document.getElementById('scratch-2'),
        context = canvas.getContext('2d');
...
function generateScratchThree(){

    'use strict';
  
    var canvas = document.getElementById('scratch-3'),
        context = canvas.getContext('2d');
